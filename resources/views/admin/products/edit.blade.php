    ...
    <div class="card-body">
        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                @if($product->image)
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $product->image) }}" alt="Imagen actual" class="img-thumbnail" style="max-width: 100px;">
                </div>
                @endif
            ...
            <div class="mb-3">
                ...
                <input type="file" name="extra_image_1" class="form-control" accept="image/*">
                @if($product->extra_image_1)
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $product->extra_image_1) }}" alt="Imagen Extra 1" class="img-thumbnail" style="max-width: 100px;">
                </div>
                @endif
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="file" name="extra_image_2" class="form-control" accept="image/*">
                @if($product->extra_image_2)
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $product->extra_image_2) }}" alt="Imagen Extra 2" class="img-thumbnail" style="max-width: 100px;">
                </div>
                @endif
            </div>
